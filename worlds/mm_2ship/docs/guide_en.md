...
- [2 Ship 2 Harkinian](https://www.2ship2harkinian.com/), which runs on Windows, Linux (Steam Deck included) and Mac.
...
Important: the apworld and the game build share location IDs, so they are released together and have to come from the
same release. If they don't match, the game tells you which 2S2H version the apworld was built for and refuses to touch
your save. Grab the matching pair from the releases page rather than mixing versions.
