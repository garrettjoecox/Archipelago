...
2 Ship 2 Harkinian is a fanmade PC port of The Legend of Zelda: Majora's Mask. Because it is a native port, it comes
with enhancements like widescreen support, higher framerates, a built-in randomizer, a built-in check tracker, and many
optional quality-of-life features. If you're curious about the specifics, please
